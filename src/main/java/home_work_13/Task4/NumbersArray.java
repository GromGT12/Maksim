...
Вычисляем сумму всех элементов
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < myArray.length; i++) {
            ...
            // 1. Распечатываем i-й элемент массива - значит что в консоль должна вывестись:
            // Элемент номер 0 массива: 4,
            ...
            // в этом задании обрабатывать ошибки не нужно, это просто попрактиковать работу с массивами,
            // код снизу лучше переписать

                System.out.printf(String.valueOf(myArray.toString()));
                int sum = 0;
                sum += myArray[i];
