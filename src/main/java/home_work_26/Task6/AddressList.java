...
public class AddressList {
    public static void main(String[] args) {
        List<Addresses> addresses = List.of(
        ...
        Set<CityStreet> addressSet = addresses.stream()
                .map(address -> new CityStreet(address.getCity(), "улица: " + address.getStreet()))
                .filter(addressShort -> "Kiev".equals(addressShort.getCity())).collect(toSet());
