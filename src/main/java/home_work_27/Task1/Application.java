...
public class Application {
    public static void main(String[] args) {
        ...
        boolean vip = serviceAbonent.isAnyVipInCity(abonentList, "London");
        System.out.println(vip);

        boolean dateConnect = serviceAbonent.isAllContractedBefore(abonentList, LocalDate.of(2023, 5, 12));
        System.out.println(dateConnect);

        Abonent anyAbonents = serviceAbonent.findAnyAbonentFromCity(abonentList, "London");
