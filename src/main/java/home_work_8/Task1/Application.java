...
public class Application {
    public static void main(String[] args) {
        ...
        Person person3 = new Person("Ira", "Evseyeva", 1997, PersonGender.FEMALE, PersonFamilyStatus.SINGLE);
        Person person4 = new Person("Diana", "Dudnik", 2012, PersonGender.FEMALE, PersonFamilyStatus.MARRIED);
