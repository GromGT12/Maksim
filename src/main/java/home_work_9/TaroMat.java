...
/*Task 2
       ...
       * пластик, стекло, алюминий.
        ...
        Создайте класс CatalogProduct, в котором создайте массив объектов Tare, объект класса таромат и вызовите на нем метод, описанный выше.

        2.2 Создайте класс Receipt (чек), в котором будет два поля: String message и int amount (ProductInterface для продвинутых студентов)
        ...
        В классе CatalogProduct вызовите этов метод, а потом распечатайте полученный чек.
*/
